# DP Upgrade Remote Command Runner Installation for SureVision -Outdoor - Dual PC
...
On PC-B:
    ...
    1. Connect the Ethernet cable from PC-B to the swtich to the left most port (when looking from the front of the PC)
